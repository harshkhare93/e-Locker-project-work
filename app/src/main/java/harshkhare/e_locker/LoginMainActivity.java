...
public class LoginMainActivity extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    private Button goolgeLoginButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goolgeLoginButton = (Button) findViewById(R.id.googlelogin);
...
// options specified by gso.
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Snackbar.make(goolgeLoginButton, "Not connected to Internet", Snackbar.LENGTH_INDEFINITE).show();
    }
